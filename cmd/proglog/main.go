...
func setupFlags(cmd *cobra.Command) error {
	...
	cmd.Flags().String("server-tls-cert-file", "", "Path to TLS cert file.")
	cmd.Flags().String("server-tls-key-file", "", "Path to TLS key file.")
	cmd.Flags().String("server-tls-ca-file", "", "Path to TLS CA file.")

	cmd.Flags().String("peer-tls-cert-file", "", "Path to TLS cert file.")
	cmd.Flags().String("peer-tls-key-file", "", "Path to TLS key file.")
	cmd.Flags().String("peer-tls-ca-file", "", "Path to TLS CA file.")
